...
const names = {
  ...
  statusActive: 'status-active.svg',
  statusCar: 'status-car-orange.svg',
  statusBlocked: 'status-blocked.svg',
  profileStatusActive: 'profile-status-active.svg',
  profileStatusCar: 'profile-status-car.svg',
  profileStatusBlocked: 'profile-status-blocked.svg',
  ...
  driverAvatarDefault: 'driver-avatar-default.png',
  driverStatusNoCar: 'driver-status-no-car.png',
  driverStatusOffline: 'driver-status-offline.png',
  driverStatusOnline: 'driver-status-online.png',
  driverStatusCar: 'driver-status-car.png',
  ...
  mapLocationButton: 'location-arrow-button.png',
  ...
  priceEstimatedIcon: 'price-estimated-icon-v2.png',
  pricePickupIcon: 'price-pickup-icon-v2.png',
  priceCustomerIcon: 'price-customer-icon-v2.png',
  priceCoinIcon: 'price-coin-icon-v2.png',
